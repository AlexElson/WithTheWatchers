...
part=-1; oldpart=part; nextDialogue=1; textspeed=.5
arrowy=0; arrowdy=-1
chat1=[]
chat2=[]
chat3=[]
...
def createStats():
    ...
    for n in range(11):
        ...
        if (npcside[n]!="Winston"):
            if (npclvl[n]<=0):
                if (npcside[n]!="Kurt" and npcside[n]!="Matthew" and npcside[n]!="Adam" and npcside[n]!="Evelyn" and npcside[n]!="Frederick" and npcside[n]!="Adam" and npcside[n]!="David" and npcside[n]!="Dinah" and npcside[n]!="Robot" and npcside[n]!="Madison" and npcside[n]!="Jerry" and npcside[n]!="Ruth"):
                    npcpierces[n]=int(al/(count+1))+random.randint(-1,2)
                    npcblunt[n]=int(al/(count+1))+random.randint(-1,2)
                    npcunarmed[n]=int(al/(count+1))+random.randint(-2,1)
                    ...
                    npcpierces[n]=int(al/(count+1))+random.randint(0,2)
                    npcblunt[n]=int(al/(count+1))+random.randint(0,2)
                    npcunarmed[n]=int(al/(count+1))+random.randint(0,2)
                    npcdefense[n]=int(al/(count+1))+random.randint(1,3)
                    #if (npccontrol[n]==0 and day>=18): npcdefense[n]=int(al/(count))+random.randint(3,4)
                    npcthrowsk[n]=int(al/(count+1))+random.randint(0,4)
                    npclvl[n]=int(al/count)+random.randint(0,1)              
                ...
                if (npcheld[n]=="Bottle"): npcblunt[n]=int(npcblunt[n]*1.6); npcpierces[n]=int(npcpierces[n]*1.6)
        ...
        if (npcside[n]=="Dinah"): npcunarmed[n]=18; #a=1
        if (npcside[n]=="Matthew"): npcdefense[n]=npcdefense[n]*3; #a=1
        if (npcside[n]=="Robot"): npcunarmed[n]=14; npcdefense[n]=17; npcblunt[n]=0; npcpierces[n]=0; npcthrowsk[n]=0
...
def story():
    ...
    if (level=="Floor"):
        ...
        choice2[part]="No thanks. I said I'm fine."; choice2go[part]=50
        ...
        chat1[part]="No thanks. I said I'm fine. I'd prefer"
    ...
    if (level=="Kurt"):
        ...
        chat1[part]="Still with me? Focus! You aren't just skipping"
        chat2[part]="the text, are you? "
        chat3[part]=""
        ...
        chat1[part]="When you level up, try to focus on only one or"
        chat2[part]="two skills. After all, why level up your blunt"
        chat3[part]="when you'd rather use piercing weapons?"
    ...
    if (level=="Outside"):
        ...
        chat3[part]="the viewers will eat it up!"
    ...
    if (level=="Frederick"):
        ...
        chat1[part]="Ah, yes! I see it now! \"An In-depth Look at the"
    ...
    if (level=="Ruth"):
        ...
        chat1[part]="What!? No! I, er, I mean. You'll...you'll"
        chat2[part]="get hurt!"
        chat3[part]=""
    ...
    if (level=="Lucas"):
        ...
        chat3[part]="fulfil your assignment before morning."
    ...
    if (level=="Ambush"):
        ...
        chat1[part]="Caught you this time!"
        part=28; speaker[part]="Winston"
    ...
    if (level=="Blackmail"):
        ...
        chat2[part]="any more? My name's Lucas."
        chat3[part]=""
        musicplay[part]="None"
        part=17
    ...
    if (level=="Split"):
        ...
        chat1[part]="I don't want to work with security any more. Get"
    ...
    if (level=="Jerry"):
        ...
        npcc=2; npc[npcc]=1; npcside[npcc]="Thug"; npcx[npcc]=20; npcy[npcc]=10; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=0; npcheld[npcc]="Bottle" #Create NPCs     
    ...
    if (level=="Questions"):
        ...
        chat1[part]="No...I think that the law is not something"
    ...
    if (level=="Save"):
        ...
        npcc=3; npc[npcc]=1; npcside[npcc]="Brute"; npcx[npcc]=6; npcy[npcc]=7; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=0; npcheld[npcc]="Hammer" #Create NPCs
        ...
        npcc=6; npc[npcc]=1; npcside[npcc]="Strangler"; npcx[npcc]=2; npcy[npcc]=9; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=0; npcheld[npcc]="Knife" #Create NPCs
        ...
        chat3[part]=""
        part=35; speaker[part]="Winston"
        chat1[part]="As long as you're okay."
        chat2[part]=""
        chat3[part]=""
        musicplay[part]="None"
        part=36
    ...
    if (level=="Gone"):
        ...
        chat3[part]=""
        part=43; speaker[part]="Floyd"
        chat1[part]="But first, we must find a new safe house."
        chat2[part]=""
        chat3[part]=""
        musicplay[part]="None"
        part=44
    ...
    if (level=="Brawl"):
        dorandomizeItems=0
        item[0]="Bottle"; itemx[0]=10; itemy[0]=3
        item[1]="Med Kit"; itemx[1]=10; itemy[1]=3
    ...
    if (level=="Report"):
        ...
        item[2]="Knife"; itemx[2]=14; itemy[2]=8
        sky=pygame.image.load("Images/skyorange.png").convert_alpha()
        ...
        npcc=4; npc[npcc]=1; npcside[npcc]="Guard"; npcx[npcc]=13; npcy[npcc]=8; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Glass"  #Create NPCs        
        npcc=5; npc[npcc]=1; npcside[npcc]="Security"; npcx[npcc]=6; npcy[npcc]=10; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Baton"  #Create NPCs        
    ...
    if (level=="Memory"):
        ...
        chat1[part]="My head...it hurts so much..."
        part=46; speaker[part]="Winston"
        ...
        chat1[part]="I remember...a white room..."
        part=50; speaker[part]="Winston"
    ...
    if (level=="Gamble"):
        ...
        musicplay[part]="standby"
        part=4; speaker[part]="Lenna"
        chat1[part]="I just...I remember this casino. I faintly"
        ...
        chat2[part]="similar to a peculiar girl who came through here"
        ...
        chat1[part]="Hurry, before more of them come!"
        part=51
        createnpc[part]=4
        partdelay[part]=20
        musicplay[part]="None"
    ...
    if (level=="Lab"):
        ...
        npcc=2; npc[npcc]=0; npcside[npcc]="Experiment"; npcx[npcc]=13; npcy[npcc]=5; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="" #Create NPCs
        ...
        chat1[part]="This is a laboratory."
        musicplay[part]="calm"
        ...
        part=67; speaker[part]="Winston"
        chat1[part]="Well...let's hurry back before more of them"
    ...
    if (level=="Talk"):
        ...
        part=6; speaker[part]="Lenna"
        chat1[part]="Wait. No, I don't want my memory back..."
        musicplay[part]="calm"
        part=7; speaker[part]="Winston"
        chat1[part]="Huh? Why?"
        part=8; speaker[part]="Lenna"
        ...
        chat3[part]="occurred, right? Those people miss the point..."
        ...
        part=49; speaker[part]="Winston"
        chat1[part]="Hey...get some sleep, all right? We'll think"
    ...
    if (level=="NoRuth"):
        ...
        if (floyd>=2):
            ...
            chat2[part]="But how? End all communication...? They sound like"
        ...
        chat2[part]="I wonder though, what would happen if none"
        chat3[part]="of my friends were willing to help me?"
        musicplay[part]="None"
        part=10
        changelevelpart=part; changelevelto="LevelMenu"; day=day; chapter+=1
    if (level=="Ruth4"):
    ...
    if (level=="Lobby"):
        ...
        npcc=3; npc[npcc]=1; npcside[npcc]="Officer"; npcx[npcc]=6; npcy[npcc]=3; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Baton" #Create NPCs
        ...
        npcc=5; npc[npcc]=0; npcside[npcc]="Strangler"; npcx[npcc]=8; npcy[npcc]=7; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Hammer" #Create NPCs
        npcc=6; npc[npcc]=0; npcside[npcc]="Officer"; npcx[npcc]=8; npcy[npcc]=11; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="" #Create NPCs
        part=1
        partdelay[part]=10
        part=2
        ...
        part=17
        part=20; speaker[part]="Winston"
        chat1[part]="I don't feel right about this..."
        chat2[part]=""
        chat3[part]=""
        part=21; speaker[part]="Lucas"
        ...
        chat1[part]="People will follow themselves. Maybe follow an"
    ...
    if (level=="Friends"):
        ...
        chat1[part]="Floyd? Lenna?...It doesn't matter any more."
    ...
    if (level=="Escape"): #Escape
        ...
        chat1[part]="The whole land is desolate; yet I will not"
        chat2[part]="make a full end."
        chat3[part]=""
        part=33; speaker[part]="Lucas"
        chat1[part]="What will happen now?"
        part=34; speaker[part]="Voice"
        chat1[part]="Your rebellion, your attempt to becomes gods"
        chat2[part]="of yourselves, has left the earth in chaos."
        chat3[part]="Genesis will soon begin."
        ...
        chat2[part]="great wrath, because he knows that he has a"
        chat3[part]="short time. Begone, Lucifer!"
    ...
    if (level=="FloydChoice"):
        ...
        chat3[part]=""
        part=29; speaker[part]="Winston"
        chat1[part]="But how will we destroy the hotel? Not to"
    ...
    if (level=="Jerry2"):
        ...
        chat1[part]="I've changed! I'm not some thug no more!"
        ...
        chat1[part]="Please! I'm sorry! I get it, what I did"
    ...
    if (level=="Climb"):
        ...
        npcc=2; npc[npcc]=1; npcside[npcc]="Man"; npcx[npcc]=10; npcy[npcc]=8; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="" #Create NPCs
        ...
        npcc=5; npc[npcc]=1; npcside[npcc]="Resident"; npcx[npcc]=5; npcy[npcc]=9; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=0; npcheld[npcc]="" #Create NPCs
        ...
        musicplay[part]="None"
        part=8; speaker[part]="Winston"
        chat1[part]="Great. Listen, if we reach the elevator, we can"
        chat2[part]="avoid the rest of the fighting. But, we would miss"
        chat3[part]="out on whatever items we find."
        musicplay[part]="threefour"
        part=9
        controlChar=part
        part=15
    ...
    if (level=="Summit"):
        ...
        chat3[part]=""
        part=8; speaker[part]="Winston"
        chat1[part]="What!? Are you insane!? You can't just...I mean,"
    ...
    if (level=="Unity"):
        ...
        chat3[part]="This Tower of Babel, vain speech, lies!"
        ...
        chat3[part]=""
        part=8; speaker[part]="Floyd"
        chat1[part]="We summoned nothing! The greed, fornication,"
    ...
    if (level=="Watchers"):
        ...
        chat3[part]=""
        part=18; speaker[part]="Floyd"
        chat1[part]="Sanders, or should I say, Satan, rebelled against"
        chat2[part]="God long ago, prior to the creation of this world."
        chat3[part]="His rebellion left the earth without form and void."
        part=19; speaker[part]="Floyd"
        chat1[part]="Of course, he was known as Lucifer at this time."
        chat2[part]="Now, Satan is the prince of this world. He furthers"
        chat3[part]="sin and deceit. But, we have stopped him for now."
        part=20; speaker[part]="Floyd"
    ...
    if (level=="LennaChoice"):
        ...
        part=7; speaker[part]="Lenna"
        chat1[part]="Then we use it...and then..."
        part=8; speaker[part]="Winston"
    ...
    if (level=="Experiment"):
        ...
        npcc=5; npc[npcc]=1; npcside[npcc]="Experiment"; npcx[npcc]=13; npcy[npcc]=7; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Knife" #Create NPCs
        npcc=6; npc[npcc]=1; npcside[npcc]="Strangler"; npcx[npcc]=12; npcy[npcc]=4; npcdx[npcc]=npcx[npcc]; npcdy[npcc]=npcy[npcc]; npccontrol[npcc]=0; npcdir[npcc]=1; npcheld[npcc]="Knife" #Create NPCs
        part=1
        partdelay[part]=10
        part=2
    ...
    if (level=="Science"):
        ...
        part=44; speaker[part]="Lenna"
        chat1[part]="The device...it's, right ahead. I remember"
    ...
    if (level=="Device"):
        ...
        chat3[part]=""
        part=30; speaker[part]="Winston"
        chat1[part]="Heh, doesn't matter any more."
        part=31; speaker[part]="Winston"
    ...
    if (level=="Reset"):
        ...
        part=4; speaker[part]="Winston"
        chat1[part]="It feels eerily familiar, as though I've"
    ...
    if ((part==controlChar or level=="Questions" or level=="Idea" or level=="Talk" or level=="Friends") and lvlingup==0 and failurepart!=part):# and npcani[whogoes]==""):
        ...
        if (level=="Science"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=40
            if (npcani[0]=="" and npcani[1]=="" and npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1 and npcdead[7]==1):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Experiment"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=20
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1): #and npcdead[7]==1):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1 or npcdead[1]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        if (level=="Robot"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=30
            if (npcani[0]=="" and npcani[3]=="" and npcdead[2]==1):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Unity"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=20
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Confusion"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=20
            if (npcani[0]=="" and npcdead[1]==1 and npcdead[2]==1 and npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Speechless"):
            ...
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=15
            if (npcdead[1]==1 and npcani[0]=="" and part==13):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Climb"):
            for m in range(11): #17/5
                if (npcy[m]==17 and npcx[m]==5 and lvlingup==0 and wally[int(npcx[m])+int(npcy[m]-1)*lvlW]==1):
                    actionmenu=0; showDist=-1; showDist2=-1; updating=2
                    am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                    part=15
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Jerry2"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=45; gainparty=""
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Friends"):
            ...
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=55
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and controlChar==part):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[1]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Lobby"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=20
            if (npcani[0]=="" and npcani[1]=="" and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1 and part==17):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Lab"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=50
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and npcdead[4]==1): # and npcdead[5]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Gamble"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=50
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and npcdead[6]==1 and npcdead[7]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Report"):
            for m in range(11):
                if (npcy[m]==8 and npcx[m]==10 and lvlingup==0 and wally[int(npcx[m])+int(npcy[m]-1)*lvlW]==1):
                    actionmenu=0; showDist=-1; showDist2=-1; updating=2
                    am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                    part=29
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Dinah"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=29
            if (npcani[0]=="" and npcani[1]=="" and npcdead[2]==1 and npcdead[3]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Brawl"):
            ...
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=60
            if (npcani[0]=="" and npcani[1]=="" and npcdead[5]==1 and part==51 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Murder"): #end chapter
            ...
            if (npcdead[1]==1 and npcani[1]=="Fall" and npcani[0]==""):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Fight"):
            ...
            if (endlevel==2):
                ...
                showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
            if (part==48 and npcdead[3]==1 and npcstrangle[2]!=1 and npcstrangle[3]!=1 and npcani[0]=="" and npcani[1]==""):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Outside"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=24
            if (npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1 and npcdead[7]==1 and npcani[0]=="" and npcani[1]=="" and npcani[2]=="" and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
        ...
        if (level=="Ambush"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=39
            if (npcdead[2]==1 and npcdead[3]==1 and npcdead[4]==1 and npcani[0]=="" and npcani[1]=="" and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Break"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=40
            if (npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1 and npcani[0]=="" and npcani[1]=="" and npcani[2]=="" and npcani[8]=="" and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Split"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=40
            if (npcdead[3]==1 and npcani[0]=="" and npcani[1]=="" and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Jerry"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=40
            if (npcani[0]=="" and npcdead[2]==1 and npcdead[4]==1 and npcdead[5]==1): #and npcdead[6]==1 and npcdead[7]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Save"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=30
            if (npcani[0]=="" and npcani[1]=="" and npcani[2]=="" and npcdead[3]==1 and npcdead[4]==1 and npcdead[5]==1 and npcdead[6]==1 and npcdead[7]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
        ...
        if (level=="Gone"):
            if (endlevel==2):
                ...
                am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
                part=30
            if (npcani[0]=="" and npcani[1]=="" and npcani[2]=="" and npcdead[3]==1 and npcdead[4]==1): #and npcdead[5]==1 and npcdead[6]==1 and lvlingup==0):
                endlevel=1
            else:
                endlevel=0
            if (npcdead[0]==1): part=100; actionmenu=0; showDist=-1; showDist2=-1; updating=2; am_actions=0; showPaths=0; actionselect=0; bodyselect=0; openbody=-1; bodymenu=-1
            ...
            for m in range(lvlW*lvlH-lvlW):
                ...
                if (back==2):
                    ...
                    if (npcrightleg[nn]>4 or npcleftleg[nn]>4 and npcside[nn]!="Host" and controlChar==part):
                        diz=random.randint(1,6)
                        for nnn in range(11):
                            if (npcdead[nnn]==1 and npcx[nnn]==npcx[whogoes] and npcy[nnn]==npcy[whogoes]):
                                diz=2
...
def EndGame():
    ...
    if (day==46):
        if (part==30 or part==31 or part==32):
            updating=2; endreset=1
...
def nextMessage():
    ...
    if (part==changelevelpart and zooming==0):
        zooming=1; level=changelevelto; loadedparty=0
...
def Failure():
    ...
    global actionalready, movedalready, lucastwo, jerry, Dinah
...
def npcEffects():
    ...
    for n in range(11):
        ...
        if (npcdead[n]==1 and npcani[n]=="Strangling"): npcani[n]="Hanging"
        if (npcani[n]=="Hanging" and npcstrangle[n]!=1): npcani[n]="Fall"; npcaniframe[n]=0
        if (npcfainted[n]<=0 and npcdead[n]==0):
...
def Attack():
    ...
    if (npcheld[whogoes]=="Scissors"):
        dam=random.randint(3,8); damtype="Pierce";
        if (mute==0):slash.play()
...
def displayActionMenu():
    ...
    if (am_actions==2 or bodymenu>=0):
        ...
        if (check=="Strangle"):
            for nn in range(11):
                if (npc[nn]==1 and npcside[nn]!="Commander" and (npcside[nn]!="Floyd" or level!="Friends") and (npcside[nn]!="Lenna" or level!="Speechless") and (npcside[nn]!="Man" or level!="Brawl") and (npcside[nn]!="Woman" or level!="Brawl") and (npcside[nn]!="Sanders" or level!="Unity") and ((npcani[nn]=="" and npcstrangle[nn]==0) or (npcstrangle[nn]==1 and npcstrangle[whogoes]==2))):
                    a=0
...
def displayLevelMenu():
    ...
    if (day==23):
        ...
        for n in range(a):
            ...
            if (n==4 and lenna+lucas+floyd<6):  screen.blit(message_portrait,(WIDTH/2-40+n*onfacedist-onface2,HEIGHT-100),(0,48*2,92,48))
            if (n==4 and lenna+lucas+floyd>=6): screen.blit(message_portrait,(WIDTH/2-40+n*onfacedist-onface2,HEIGHT-100),(0,48*(2+7),92,48))
    if (day==30):
        a=1
        for n in range(a):
            if (n==0): screen.blit(message_portrait,(WIDTH/2-40+n*onfacedist-onface2,HEIGHT-100),(0,48*3,92,48))
    ...
    if (gainparty==""):
        if (pressed==1 and lmselect==1 and lmsure==0): #Entered over a Face
            ...
            if ((day==17 or day==18) and onface==1 and Dinah==0): zooming=1; level="Dinah"; gainparty="Dinah"; Dinah=1 #Dinah
            ...
            if (day==23 and onface==4 and lenna+lucas+floyd<6): zooming=1; level="WinstonChoice" #Winston
            #LucasChoice
...
while mainLoop:
    ...
    for event in pygame.event.get():
        ...
        if (event.type==pygame.MOUSEBUTTONDOWN and event.button==1): #Left Mouse Click
            ...
            if (event.key==K_RETURN): pressed=1; delaycam=0; updating=2; textspeed=1.5
